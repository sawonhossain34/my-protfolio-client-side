...
const TopSection = () => {
    ...
    return (
        <div className="hero min-h-screen bg-black relative">
            ...
            <div className="bg-gray-700 w-full opacity-20 -bottom-7 p-12 flex flex-cols-2 lg:flex-cols-4 justify-around items-center gap-4 absolute">
